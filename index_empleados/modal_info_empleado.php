    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-empleado-form" action="procesar_empleado.php" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="num_telefonico" name="num_telefonico" value="<?php echo htmlspecialchars($num_telefonico); ?>" required>
                        </div>
                        <div class="col-md-4 mb-3">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id="saveEmpleadoBtn" form="edit-empleado-form">Guardar Cambios</button>
